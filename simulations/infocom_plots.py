...
class InfocomPlotter(lte.tool.PlottingTool):
    def __init__(self):
        ...
        self.add_plot("simple_welfare", [
            ...
            Welfare(6, label='ProportionalFair', color='g', marker='^', markevery=200),
            Welfare(7, label='Classic UWR',      color='b', marker='>', markevery=200),
            Welfare(8, label='MaxRate UWR',      color='m', marker='<', markevery=200)
        ])

        self.add_plot("simple_efficiency", [
            RoundEfficiency(5, label='MaxRate',          color='r', marker='v', markevery=3000),
            RoundEfficiency(6, label='ProportionalFair', color='g', marker='^', markevery=3000),
            RoundEfficiency(7, label='Classic UWR',      color='b', marker='>', markevery=3000),
            RoundEfficiency(8, label='MaxRate UWR',      color='m', marker='<', markevery=3000)
        ])

        self.add_plot("simple_total_vs_possible", [
            TotalVsPossible(5, label='MaxRate',          color='r', marker='v', linestyle='none', markevery=200),
            TotalVsPossible(6, label='ProportionalFair', color='g', marker='^', linestyle='none', markevery=200),
            TotalVsPossible(7, label='Classic UWR',      color='b', marker='>', linestyle='none', markevery=200),
            TotalVsPossible(8, label='MaxRate UWR',      color='m', marker='<', linestyle='none', markevery=200),
